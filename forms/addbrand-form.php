        ...
        <div class="fields flex flex-col gap-y-3">
            ...
            <div class="fullname-fields grid grid-cols-1 md:grid-cols-2 gap-3">
                <label class="input input-bordered flex items-center gap-2">
                    ...
                    <input type="text" placeholder="nom de la marque" name="nom_marque" required title="minimum 2 caractères" pattern="^(?!\s*$).{2,}$" class="grow" />
                </label>
                <label class="input validator">
                    ...
                    <input type="url" name="logo" required placeholder="url du logo: https://..." pattern="^(https?://)?([a-zA-Z0-9]([a-zA-Z0-9\-].*[a-zA-Z0-9])?\.)+[a-zA-Z].*$" title="Must be valid URL" />
                </label>
