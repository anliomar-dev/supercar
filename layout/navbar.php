	...
	<body>
		...
		<nav class="flex justify-around items-center py-3 px-6 lg:px-12 shadow-md sticky top-0 bg-base-100" style="z-index: 2000;">
			...
			<div class="nav-menu fixed lg:static top-14 w-full px-6 h-auto py-3 hidden lg:flex lg:justify-center">
				<ul class="flex flex-col lg:flex-row lg:justify-center gap-3 bg-primary lg:bg-transparent py-[55px] lg:py-0 h-full rounded-lg px-10" id="">
						...
						<div class="dropdown dropdown-hover w-full">
							<a class="flex gap-2 w-full justify-center py-2 font-medium btn btn-primary
								...
								<div tabindex="0" role="button" class="flex items-center gap-x-2" style="font-weight: 750;">
									<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 test">
							...
							<ul tabindex="0" class="dropdown-content menu bg-base-100 rounded-box z-[1] w-auto shadow">
								...
								<li><a href="">Toutes nos voitures</a></li>
					...
					<li class="btn btn-primary lg:bg-transparent min-h-0 h-8 m-1 border-none flex items-center">
						<a href="#about" class="flex gap-2 w-auto justify-start py-2 font-medium">
					...
					<li class="btn btn-primary lg:bg-transparent min-h-0 h-8 m-1 border-none flex items-center">
						<a href="#experience" class="flex gap-2 w-auto justify-start py-2 font-medium">
							<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
								<path stroke-linecap="round" stroke-linejoin="round" d="M4.26 10.147a60.438 60.438 0 0 0-.491 6.347A48.62 48.62 0 0 1 12 20.904a48.62 48.62 0 0 1 8.232-4.41 60.46 60.46 0 0 0-.491-6.347m-15.482 0a50.636 50.636 0 0 0-2.658-.813A59.906 59.906 0 0 1 12 3.493a59.903 59.903 0 0 1 10.399 5.84c-.896.248-1.783.52-2.658.814m-15.482 0A50.717 50.717 0 0 1 12 13.489a50.702 50.702 0 0 1 7.74-3.342M6.75 15a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5Zm0 0v-3.675A55.378 55.378 0 0 1 12 8.443m-7.007 11.55A5.981 5.981 0 0 0 6.75 15.75v-1.5" />
							</svg>
					...
					<li class="btn btn-primary lg:bg-transparent min-h-0 h-8 m-1 border-none flex items-center">
						<a href="#cars" class="flex gap-2 w-auto justify-start py-2 font-medium">
							<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
					...
					<li class="btn btn-primary lg:bg-transparent min-h-0 h-8 m-1 border-none flex items-center">
						<a href="#test-steps" class="flex gap-2 w-auto justify-start py-2 font-medium">
							<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
			...
			<div class="hidden lg:flex">
				<button class="btn btn-primary h-10 min-h-0">login</button>
			</div>
