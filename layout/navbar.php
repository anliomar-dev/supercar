	...
	<body>
		...
		<nav class="flex justify-around items-center py-3 px-6 shadow-md sticky top-0 bg-base-100" style="z-index: 2000;">
			...
			<div class="nav-menu fixed lg:static top-14 w-full px-6 h-auto py-3 hidden lg:flex lg:justify-center">
				<ul class="flex flex-col lg:flex-row lg:justify-center gap-4 bg-primary lg:bg-transparent py-[55px] lg:py-0 h-full rounded-lg px-10" id="">
					<li class="">
					...
					<li class="">
						<a href="" class="flex gap-2 items-center w-auto justify-start py-2 font-medium">
							...
							<span class="pt-1">Collection</span>
						</a>
					</li>
					<li class="">
						<a href="" class="flex gap-2 items-center w-auto justify-start py-2 font-medium">
							...
							<span class="pt-1">reservtion</span>
						</a>
					</li>
				</ul>
			</div>
