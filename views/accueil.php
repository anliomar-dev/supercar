	...
	<body class="relative">
		...
		<section class="how-it-work px-8 md:px-16 lg:px-28 py-10 md:py-20 scroll-mt-20" id="test-steps">
			...
			<div class="flex justify-center pt-8">
				<a href="/supercar/dashboard/demande_essai/" class="btn btn-primary">Passez à l'action</a>
			</div>
		</section>
		...
		<a href="#hero" class="fixed right-3 bottom-5 btn btn-primary rounded-full scroll-to-top-btn hidden">
