...
<div class="flex-1 p-6">
	<div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 max-w-6xl mx-auto mt-6">
		...
		<a href="/supercar/admin/images" class="card py-3 shadow-md bg-gradient-to-r from-orange-100 to-white
			hover:from-orange-200 hover:to-base-200 hover:scale-105 hover:shadow-md
			hover:-translate-y-3 transition-all duration-400 ease-in-out">
			<div class="card-body items-center justify-center">
		...
		<a href="/supercar/admin/utilisateurs/moi" class="card py-3 shadow-md bg-gradient-to-r from-orange-100 to-white
			hover:from-orange-200 hover:to-base-200 hover:scale-105 hover:shadow-md
			hover:-translate-y-3 transition-all duration-400 ease-in-out">
			<div class="card-body items-center justify-center">
				...
				<h2 class="font-bold text-lg">mon profile</h2>
			</div>
		</a>
