<div class="drawer-side  bg-base-300 w-64">
    ...
    <ul class="menu text-base-content min-h-full w-64 p-4 gap-y-3 mt-20 lg:mt-6 z-20">
        ...
        <li>
            <a href="/supercar/admin/utilisateurs" class="utilisateurs">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
        ...
        <li class="">
            <a href="/supercar/admin/images" class="images">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
        ...
        <li>
            <a href="/supercar/admin/demande_essais" class="demande_essais">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
        ...
        <li>
            <a href="/supercar/admin/evennements" class="evennements">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
        ...
        <li>
            <a href="/supercar/admin/contacts" class="contacts">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
