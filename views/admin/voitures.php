				...
				<?php else: ?>
					<div class="join">
						<?php if(str_ends_with($_SERVER["REQUEST_URI"], "create")): ?>
							<a href="/supercar/admin/voitures" class="btn join-item">Voitures</a>
							<a href="/supercar/admin/voitures/create" class="btn btn-primary join-item">Ajouter</a>
						<?php else:?>
							<a href="/supercar/admin/voitures" class="btn btn-primary join-item">Voiytures</a>
							<a href="/supercar/admin/voitures/create" class="btn join-item">Ajouter</a>
						<?php endif; ?>
					</div>
				<?php endif; ?>
			</div>
							...
							<?php foreach($paginated_cars["data"] as $car): ?>
								<tr>
									...
									<th>
										...
										<a class="btn btn-ghost btn-xs" href="/supercar/admin/voitures/delete?car=<?php echo $car["id_modele"]; ?>">
