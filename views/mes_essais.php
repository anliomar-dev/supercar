	...
	<div class="w-full h-full flex flex-col items-start
		...
		<div class="personal-data-page bg-base-100 h-full w-full md:w-[900px] rounded-lg flex border">
			...
			<div class="personal-data-wrapper p-6 w-full md:w-9/12">
				...
				<div class="grid grid-cols-1 lg:grid-cols-2 gap-3 py-3">
					<?php if(!empty($mes_essais)): ?>
						<?php foreach($mes_essais as $e): ?>
							<div class="card bg-base-100 shadow-xl border border-gray-200">
								<div class="card-body">
									<h2 class="card-title text-lg text-primary">
										<?php echo $e["nom_modele"]; ?>
										<span class="text-sm text-gray-400 font-normal">/ <?php echo $e["nom_marque"]; ?> </span>
									</h2>
									<p><strong>Date :</strong> <?php echo $e["date_essai"]; ?> </p>
									<p><strong>Heure :</strong> <?php echo $e["heure"]; ?> </p>
									<p>
										<strong>Statut :</strong>
                                        <?php if($e["status"] == "en_attente"): ?>
											<span class="badge bg-blue-500 text-white"><?php echo "en attente"; ?></span>
										<?php elseif($e["status"] == "confirme"): ?>
											<span class="badge bg-success text-white"><?php echo "confirmée"; ?></span>
										<?php elseif($e["status"] == "annule"): ?>
											<span class="badge bg-error text-white"><?php echo "annulée"; ?></span>
										<?php elseif($e["status"] == "termine"): ?>
											<span class="badge bg-base-300"><?php echo "terminée"; ?></span>
										<?php endif; ?>
									</p>
								</div>
							</div>
